...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatList'
        db.create_table('character_statlist', (
            ...
            ('expression', self.gf('django.db.models.fields.IntegerField')()),
            ('focus', self.gf('django.db.models.fields.IntegerField')()),
            ('mind', self.gf('django.db.models.fields.IntegerField')()),
            ('soul', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('character', ['StatList'])


    def backwards(self, orm):
        # Deleting model 'StatList'
        db.delete_table('character_statlist')
    ...
    models = {
        ...
        'character.applaud': {
            ...
            'time': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'})
        },
