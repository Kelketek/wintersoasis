...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('character_tagdef', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['character.TagCategory'])),
        ...
        db.create_table('character_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['objects.ObjectDB'])),
    ...
    models = {
        ...
        'character.tag': {
            ...
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['objects.ObjectDB']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'character.tagdef': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['character.TagCategory']"}),
