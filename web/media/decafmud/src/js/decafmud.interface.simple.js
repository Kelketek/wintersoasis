...
SimpleInterface.prototype.displayInput = function(text) {
	...
	if ( (!this.display) || (!this.echo) || ( /^@@$/.test(text) ) ) { return; }
...
SimpleInterface.prototype.handleInput = function(e) {
	...
	if ( e.keyCode === 13 ) {
                if ( this.input.value ) {
                    this.command_history.push(this.input.value);
                    if ( this.command_history.length > this.max_history ) {
                        this.command_history.shift();
                    }
                    this.history_marker = this.command_history.length;
                }
		this.decaf.sendInput(this.input.value);
		this.input.select();
	}
